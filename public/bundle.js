var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button0, "class", button0_class_value = "" + (null_to_empty(/*current*/ ctx[0] === 'MTL' ? 'selected' : '') + " svelte-6h2s5o"));
    			add_location(button0, file$1, 31, 2, 665);
    			attr_dev(button1, "class", button1_class_value = "" + (null_to_empty(/*current*/ ctx[0] === 'MAL' ? 'selected_two' : '') + " svelte-6h2s5o"));
    			add_location(button1, file$1, 33, 2, 775);
    			attr_dev(div0, "class", "buttons svelte-6h2s5o");
    			add_location(div0, file$1, 30, 0, 639);
    			attr_dev(i, "class", "mi mi-undo svelte-6h2s5o");
    			add_location(i, file$1, 38, 2, 929);
    			attr_dev(div1, "class", "refresh svelte-6h2s5o");
    			add_location(div1, file$1, 37, 2, 904);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*current*/ 1 && button0_class_value !== (button0_class_value = "" + (null_to_empty(/*current*/ ctx[0] === 'MTL' ? 'selected' : '') + " svelte-6h2s5o"))) {
    				attr_dev(button0, "class", button0_class_value);
    			}

    			if (!current || dirty & /*current*/ 1 && button1_class_value !== (button1_class_value = "" + (null_to_empty(/*current*/ ctx[0] === 'MAL' ? 'selected_two' : '') + " svelte-6h2s5o"))) {
    				attr_dev(button1, "class", button1_class_value);
    			}

    			const grid_changes = {};
    			if (dirty & /*data*/ 4) grid_changes.data = /*data*/ ctx[2];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		...
    		const response = await fetch("https://hub.dummyapis.com/employee?noofRecords=6&idStarts=1001");

    		$$invalidate(1, resData = await response.json());
    		console.log(resData);
    		$$invalidate(2, data = resData);
    	});
    	...
    	const click_handler = () => $$invalidate(0, current = 'MTL');
    	const click_handler_1 = () => $$invalidate(0, current = 'MAL');

    	const click_handler_2 = () => {
    		$$invalidate(2, data = resData);
    	};

    	$$self.$capture_state = () => ({ onMount, Grid: Gridjs, current, resData, data });

    	$$self.$inject_state = $$props => {
    		if ('current' in $$props) $$invalidate(0, current = $$props.current);
    		if ('resData' in $$props) $$invalidate(1, resData = $$props.resData);
    	...
    	return [current, resData, data, click_handler, click_handler_1, click_handler_2];
    }
