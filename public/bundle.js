var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button0, "class", button0_class_value = "" + (null_to_empty(/*current*/ ctx[2] === "MTL" ? "selected" : "") + " svelte-6h2s5o"));
    			add_location(button0, file$1, 65, 2, 1461);
    			attr_dev(button1, "class", button1_class_value = "" + (null_to_empty(/*current*/ ctx[2] === "MAL" ? "selected_two" : "") + " svelte-6h2s5o"));
    			add_location(button1, file$1, 69, 2, 1572);
    			attr_dev(div0, "class", "buttons svelte-6h2s5o");
    			add_location(div0, file$1, 64, 0, 1437);
    			attr_dev(i, "class", "mi mi-undo svelte-6h2s5o");
    			add_location(i, file$1, 76, 2, 1729);
    			attr_dev(div1, "class", "refresh svelte-6h2s5o");
    			add_location(div1, file$1, 75, 0, 1705);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(i, "click", /*click_handler_2*/ ctx[6], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*current*/ 4 && button0_class_value !== (button0_class_value = "" + (null_to_empty(/*current*/ ctx[2] === "MTL" ? "selected" : "") + " svelte-6h2s5o"))) {
    				attr_dev(button0, "class", button0_class_value);
    			}

    			if (!current || dirty & /*current*/ 4 && button1_class_value !== (button1_class_value = "" + (null_to_empty(/*current*/ ctx[2] === "MAL" ? "selected_two" : "") + " svelte-6h2s5o"))) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const fetchMALData = async () => {
    		...
    		$$invalidate(0, resData = await responseFromMAL.json());
    		console.log("resData", resData);

    		$$invalidate(1, data = resData.map(data => {
    	...
    	const fetchMTLData = async () => {
    		...
    		$$invalidate(0, resData = await responseFromMTL.json());
    	...
    	$$self.$inject_state = $$props => {
    		if ('resData' in $$props) $$invalidate(0, resData = $$props.resData);
