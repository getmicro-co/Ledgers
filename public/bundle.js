var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			const grid_changes = {};
    			if (dirty & /*data*/ 1) grid_changes.data = /*data*/ ctx[0];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const handleClick = async e => {
    		...
    		if (BTN_NAME === "MAL") {
    			// call MTL FETCH
    			$$invalidate(0, data = await fetchMALData());
    		} else {
    			// call MAL FTECH
    			$$invalidate(0, data = await fetchMTLData());
    		}
    	};
    	...
    	return [data, current, handleClick, click_handler, click_handler_1];
    }
